...
const App3=()=> {
    ...
    <Flickity className="book" options={{wrapAround: true,initialIndex: 2}}>
        ...
        <div className="book-cards">
          ...
          <div className="book-card">
            ...
            <div className="likes">
              ...
              <div className="like-name">
                <span>Angelina Stone</span> and<span> 2 other friends</span> like
                this
              </div>
            </div>
          </div>
          ...
          <div className="book-card">
            ...
            <div className="likes">
              ...
              <div className="like-name">
                <span>Samantha William</span> and<span> Jonathan</span> like this
              </div>
            </div>
          </div>
        </div>
