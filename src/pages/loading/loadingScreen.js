...
import { getItems, getServerId } from '../../localStorage';
      ...
      const fetchData = async () => {
        ...
        Axios.post(getServerId()+"/get-tags",{
          ...
          setTags(res.data)
            ...
            setHighlight(highlightItems);
            setItems([...regularItems, ...highlightItems]);
            setCart(getItems())
            setLoading(false);
            setcurrent(true)
      }
    ...
    <div className="border-animation">
      ...
      >
        ...
        <defs>
          ...
          <g id="cat">
            <circle fill="#0170BB" cx={1115} cy={625} r={25} />
            <path
              fill="#FFF"
              stroke="#0170BB"
              strokeWidth={3}
          ...
          <g id="ball">
            <circle fill="#FFF" className="stroke" cx={446} cy="803.8" r="47.3" />
            <line
              fill="none"
              className="stroke"
              x1={446}
          ...
          <g id="plane">
            ...
            <use className="helix" xlinkHref="#helix" filter="url(#f1)" />
            <line
              fill="none"
              className="stroke"
              x1={728}
        ...
        <use className="box" xlinkHref="#box" x={20} y={30} />
        <use className="parachute" xlinkHref="#parachute" x={20} y={-112} />
        <rect fill="white" x={320} y={310} width={665} height={238} />
        <use className="tshirt" xlinkHref="#tshirt" />
        <use className="cap" xlinkHref="#cap" y={-150} />
        <use className="ball" xlinkHref="#ball" y={-140} />
        <use className="sky-circle" xlinkHref="#sky-circle" x="-10px" y={5} />
        <use className="sky-circle2" xlinkHref="#sky-circle" x="500px" y={-125} />
        <use className="sky-circle3" xlinkHref="#sky-circle" x="1000px" y={50} />
        <use className="cloud" xlinkHref="#cloud2" x={0} y={10} />
        <use className="plane" xlinkHref="#plane" y={-80} />
        <use className="cloud2" xlinkHref="#cloud" x={0} y={130} />
        <use className="trees" xlinkHref="#tree" x={40} y={0} />
        <circle className="cat-shadow" fill="#0170BB" cx={1160} cy={620} r={23} />
        <use className="cat" xlinkHref="#cat" x={15} y={5} />
        <g id="browser">
          <path
            fill="none"
            className="stroke"
          ...
          <circle fill="none" className="stroke" cx="402.2" cy="349.3" r="12.3" />
          <path
            fill="none"
            stroke="#0170BB"
            className="stroke"
          ...
          />
          <circle fill="none" className="stroke" cx="363.7" cy="349.3" r="12.3" />
        </g>
        <g id="toldo">
          <polyline
            fill="#FFF"
          ...
          />
          <use className="tol" xlinkHref="#tol" x={-250} />
          <use className="tol" xlinkHref="#tol" x={334} />
          <use className="tol" xlinkHref="#tol" x={417} />
          <line
            className="stroke round-end"
            x1={277}
            y1="470.5"
            ...
            y2="470.5"
          />
          <line className="stroke" x1={541} y1="391.8" x2="526.5" y2="471.2" />
          <line className="stroke" x1="838.8" y1="391.8" x2="860.1" y2="471.2" />
          <path
            opacity="0.4"
            fill="#0170BB"
        ...
        <g id="door">
          ...
          />
          <rect fill="#0170BB" x={730} y={700} width={225} height={15} />
          <g id="sign">
            <polyline
              fill="none"
              className="stroke"
        ...
        <use className="grass" xlinkHref="#grass" x={130} y={0} />
        <rect
          className="grass"
          x={130}
          y={850}
